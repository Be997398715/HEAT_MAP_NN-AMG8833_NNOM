...
void amg8833(int argc, char** argv)
{
	uint32_t tick, time;
...
FINSH_FUNCTION_EXPORT(amg8833, finsh_type_int, test amg8833 image for nn);
MSH_CMD_EXPORT(amg8833, atcmd sample: atcmd <server|client>);
